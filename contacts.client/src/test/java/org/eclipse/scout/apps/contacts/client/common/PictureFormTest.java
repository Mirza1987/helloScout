...
import org.eclipse.scout.apps.contacts.shared.common.IPictureService;
...
public class PictureFormTest {
    @BeanMock
    private IPictureService m_mockSvc;
// TODO [ADMIVBDM] add test cases

    @Before
    public void setup() {
        PictureFormData answer = new PictureFormData();
