...
import org.eclipse.scout.apps.contacts.server.sql.DatabaseProperties.DatabaseAutoCreateProperty;
import org.eclipse.scout.apps.contacts.server.sql.DatabaseProperties.DatabaseAutoPopulateProperty;
...
public class DatabaseSetupService implements IDataStoreService {
  ...
  private Set<String> getExistingTables() {
    ...
    SQL.selectInto(SQLs.SELECT_TABLE_NAMES, new NVPair("result", tables)); // The existing tables are stored in the StringArrayHolder object named "result".
